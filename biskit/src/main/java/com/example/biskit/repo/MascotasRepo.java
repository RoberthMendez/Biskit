...
public class MascotasRepo {
  ...
  public MascotasRepo() {
    mascotas.put(1, new Mascota(1, "Firulais", Especie.PERRO, "Pug", Estado.ACTIVO, 3, 20.5f, "Ninguna",
    ...
    mascotas.put(2, new Mascota(2, "Michi", Especie.GATO, "Siames", Estado.ACTIVO, 2, 5.0f, "Ninguna",
        "https://animalpets.co/wp-content/uploads/2024/11/Gato-Siames.png"));
    mascotas.put(3, new Mascota(3, "Rex", Especie.PERRO, "Cocker Spaniel", Estado.INACTIVO, 5, 30.0f, "Artritis",
        "https://cdn0.uncomo.com/es/posts/7/5/5/como_cuidar_de_un_cocker_spaniel_5557_600_square.jpg"));
    mascotas.put(4, new Mascota(4, "Luna", Especie.GATO, "Persa", Estado.ACTIVO, 1, 4.5f, "Ninguna",
    ...
    mascotas.put(5, new Mascota(5, "Igor", Especie.PERRO, "Salchicha", Estado.INACTIVO, 3, 25.0f, "Ninguna",
    ...
    mascotas.put(7, new Mascota(7, "Rocky", Especie.PERRO, "Bulldog", Estado.ACTIVO, 6, 28.0f, "Ninguna",
    ...
    mascotas.put(10, new Mascota(10, "Mia", Especie.GATO, "Sphynx", Estado.ACTIVO, 1, 3.0f, "Ninguna",
