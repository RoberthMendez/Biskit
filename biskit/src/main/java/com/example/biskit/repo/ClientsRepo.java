...
public class ClientsRepo {
  ...
  public ClientsRepo() {
    ...
    clients.put(1, new Client(1, "Juan Pérez", "123456789", "juan.perez@example.com", "3001234567", "juanp", "123"));
    clients.put(2, new Client(2, "María López", "987654321", "maria.lopez@example.com", "3009876543", "marial", "123"));
    clients.put(3,
        new Client(3, "Carlos Ramírez", "456789123", "carlos.ramirez@example.com", "3004567890", "carlosr", "123"));
    clients.put(4, new Client(4, "Ana Gómez", "789123456", "ana.gomez@example.com", "3007891234", "anag", "123"));
    clients.put(5,
        new Client(5, "Paula Gutiérrez", "321654987", "paula.gutierrez@example.com", "3003216549", "paulag", "123"));
    clients.put(6,
        new Client(6, "Laura Fernández", "654987321", "laura.fernandez@example.com", "3006549873", "lauraf", "123"));
    clients.put(7, new Client(7, "Andrés Res", "159753486", "andres.res@example.com", "3001597534", "andresr", "123"));
    clients.put(8,
        new Client(8, "Sofía Ramírez", "753159486", "sofia.ramirez@example.com", "3007531594", "sofiar", "123"));
    clients.put(9,
        new Client(9, "Pedro Martínez", "852456789", "pedro.martinez@example.com", "3008524567", "pedrom", "123"));
    clients.put(10,
        new Client(10, "Lucía Sánchez", "456123789", "lucia.sanchez@example.com", "3004561237", "lucias", "123"));
    ...
    clients.get(2).getPets()
        .add(new Pet(2, "Michi", Especie.GATO, "Siames", Estado.ACTIVO, 2, 5.0f, "Ninguna",
    ...
    clients.get(7).getPets()
        .add(new Pet(7, "Rocky", Especie.PERRO, "Bulldog", Estado.ACTIVO, 6, 28.0f, "Ninguna",
