...
public class PetsRepo {
    ...
    public PetsRepo() {
        ...
        pets.put(2, new Pet(2, "Michi", Especie.GATO, "Siames", Estado.ACTIVO, 2,
                5.0f, "Ninguna", "María López",
                "https://animalpets.co/wp-content/uploads/2024/11/Gato-Siames.png"));
        pets.put(3,
                new Pet(3, "Rex", Especie.PERRO, "Cocker Spaniel", Estado.INACTIVO, 5, 30.0f,
                        "Artritis",
                        "Carlos Ramírez",
