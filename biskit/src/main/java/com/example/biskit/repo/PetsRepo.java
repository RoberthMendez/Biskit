...
public class PetsRepo {
    ...
    public PetsRepo() {
        ...
        pets.put(1, new Pet(1, "Firulais", Especie.PERRO, "Pug", Estado.ACTIVO, 3,
                20.5f, "Ninguna",
        ...
        pets.put(2, new Pet(2, "Michi", Especie.GATO, "Siames", Estado.ACTIVO, 2,
                5.0f, "Ninguna", "https://animalpets.co/wp-content/uploads/2024/11/Gato-Siames.png"));
        pets.put(3, new Pet(3, "Rex", Especie.PERRO, "Cocker Spaniel", Estado.INACTIVO, 5, 30.0f,
                "Artritis",
                "https://cdn0.uncomo.com/es/posts/7/5/5/como_cuidar_de_un_cocker_spaniel_5557_600_square.jpg"));
        pets.put(4, new Pet(4, "Luna", Especie.GATO, "Persa", Estado.ACTIVO, 1, 4.5f,
                "Ninguna",
        ...
        pets.put(5,
                new Pet(5, "Igor", Especie.PERRO, "Salchicha", Estado.INACTIVO, 3, 25.0f,
                        "Ninguna",
                        "https://content.elmueble.com/medio/2025/03/18/teckel_d876849b_250318171431_900x900.webp"));
        pets.put(6, new Pet(6, "Simba", Especie.GATO, "Maine Coon", Estado.ACTIVO, 3,
                6.0f, "Ninguna",
        ...
        pets.put(7,
                new Pet(7, "Rocky", Especie.PERRO, "Bulldog", Estado.ACTIVO, 6, 28.0f,
                        "Ninguna", "https://www.kokogenetics.com/_nuxt/img/141.211e631.webp"));
        pets.put(8, new Pet(8, "Nina", Especie.GATO, "Ragdoll", Estado.INACTIVO, 2,
                5.5f, "Alergias",
        ...
        pets.put(9, new Pet(9, "Toby", Especie.PERRO, "Labrador", Estado.ACTIVO, 4,
                32.0f, "Ninguna",
        ...
        pets.put(10, new Pet(10, "Mia", Especie.GATO, "Sphynx", Estado.ACTIVO, 1,
                3.0f, "Ninguna",
